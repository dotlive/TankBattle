...
namespace AI.BehaviourTree
{
    ...
    public abstract class Node
    {
        ...
        protected abstract ERunningStatus OnUpdate(IAgent agent, BlackboardMemory workingMemory);

        protected abstract void OnReset(IAgent agent, BlackboardMemory workingMemory);
    }
}